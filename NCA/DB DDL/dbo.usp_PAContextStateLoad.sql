...
CREATE PROCEDURE [dbo].[usp_PAContextStateLoad]
AS
BEGIN
	...
	WITH Source AS (
		...
		FROM [EP].[PA].[ContextState])
	
	MERGE INTO [PA].[ContextState] AS Target
	USING Source
	...
	PRINT 'Import was successful from PA.[ContextState]'
END
GO
